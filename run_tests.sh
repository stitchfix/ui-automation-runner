...
TEST_APP_NAME="StitchFix"

# Set which simulator or device you want Instruments Automation to run with:
SIMULATOR_NAME_OR_DEVICE_UDID=${simulator_iPhone6Plus_iOS8}

# The directory in which we can find the test file you'll specify below:
JAVASCRIPT_TEST_FILES_DIRECTORY="${XCS_SOURCE_DIR}/iOSApp/StitchFixTests/"
...
TEST_RESULTS_OUTPUT_PATH="$HOME/Desktop/TEMP/"
